    ...
    public sealed class SbcInstruction : IInstruction
    {
        public IReadOnlyDictionary<byte, AddressingMode> OpCodes { get; }
            = new Dictionary<byte, AddressingMode>
            {
                ...
                {0xF2, AddressingMode.IndirectYAddressingMode}
            };
        ...
        public int Invoke(ICpu cpu, byte instruction, ushort address, byte data)
        {
            ...
            return instruction switch
            {
                ...
                0xF5 => 4,
                0xED => 4,
                0xFD => 4 + InstructionUtil.GetClockCycleByCrossingPage(cpu.Registers.Pc, address),
                0xF9 => 4 + InstructionUtil.GetClockCycleByCrossingPage(cpu.Registers.Pc, address),
                0xE1 => 6,
                0xF2 => 5 + InstructionUtil.GetClockCycleByCrossingPage(cpu.Registers.Pc, address),
                _ => 0
            };
        }
    }
